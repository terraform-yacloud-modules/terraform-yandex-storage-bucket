resource "yandex_kms_symmetric_key" "this" {
  count               = var.sse_kms_key_configuration.create_kms && var.server_side_encryption_configuration.enabled && var.server_side_encryption_configuration.kms_master_key_id == null ? 1 : 0
